...
RcppExport SEXP _LVBart_rmvnorm(SEXP meanSEXP, SEXP PrecisionSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _LVBart_rlgam(SEXP shapeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _LVBart_rcpparma_hello_world() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _LVBart_rcpparma_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _LVBart_rcpparma_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type x(xSEXP);
...
RcppExport SEXP _LVBart_rcpparma_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type x(xSEXP);
...
RcppExport SEXP _LVBart_update_b(SEXP ZSEXP, SEXP b_newSEXP, SEXP mu_newSEXP, SEXP b_oldSEXP, SEXP mu_oldSEXP, SEXP cluster_idxSEXP, SEXP sigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_LVBart_rmvnorm", (DL_FUNC) &_LVBart_rmvnorm, 2},
    {"_LVBart_rlgam", (DL_FUNC) &_LVBart_rlgam, 1},
    {"_LVBart_rcpparma_hello_world", (DL_FUNC) &_LVBart_rcpparma_hello_world, 0},
    {"_LVBart_rcpparma_outerproduct", (DL_FUNC) &_LVBart_rcpparma_outerproduct, 1},
    {"_LVBart_rcpparma_innerproduct", (DL_FUNC) &_LVBart_rcpparma_innerproduct, 1},
    {"_LVBart_rcpparma_bothproducts", (DL_FUNC) &_LVBart_rcpparma_bothproducts, 1},
    {"_LVBart_update_b", (DL_FUNC) &_LVBart_update_b, 7},
    {"_rcpp_module_boot_mod_forest", (DL_FUNC) &_rcpp_module_boot_mod_forest, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_LVBart(DllInfo *dll) {
